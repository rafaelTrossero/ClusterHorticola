 ...
 */
@Entity
public class PreciosIngreso implements Serializable {
    ...
    @OneToOne
    @JoinColumn(name = "ingresoMercado_id", referencedColumnName = "id")
    private IngresoMercado ingresoMercado;
    private Float precioFinca;
    ...
    public Float getPrecioFinca() {
        return precioFinca;
    }

    public void setPrecioFinca(Float precioFinca) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PreciosIngreso)) {
            return false;
        }
        PreciosIngreso other = (PreciosIngreso) object;
    ...
    public String toString() {
        return "entidad.PreciosIngreso[ id=" + id + " ]";
    }
